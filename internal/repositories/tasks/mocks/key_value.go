...
// Create provides a mock function with given fields: ctx, key, value, opts
func (_m *KeyValue) Create(ctx context.Context, key string, value []byte, opts ...jetstream.KVCreateOpt) (uint64, error) {
	...
	var r0 uint64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []byte, ...jetstream.KVCreateOpt) (uint64, error)); ok {
		return rf(ctx, key, value, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, []byte, ...jetstream.KVCreateOpt) uint64); ok {
		r0 = rf(ctx, key, value, opts...)
	} else {
		r0 = ret.Get(0).(uint64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, []byte, ...jetstream.KVCreateOpt) error); ok {
...
func (_c *KeyValue_Create_Call) Run(run func(ctx context.Context, key string, value []byte, opts ...jetstream.KVCreateOpt)) *KeyValue_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]jetstream.KVCreateOpt, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
				variadicArgs[i] = a.(jetstream.KVCreateOpt)
			}
		}
...
func (_c *KeyValue_Create_Call) RunAndReturn(run func(context.Context, string, []byte, ...jetstream.KVCreateOpt) (uint64, error)) *KeyValue_Create_Call {
	_c.Call.Return(run)
	return _c
}
